...
function App() {
  ...
  // Auto-initialize player when wallet connects
  useEffect(() => {
    const autoInitialize = async () => {
      if (status === 'connected' && canInitialize && !isConnectedAndInitialized) {
        console.log('🎮 Auto-initializing player after wallet connection...')
        try {
